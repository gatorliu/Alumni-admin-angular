  ...
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider',function ($stateProvider,$urlRouterProvider,$ocLazyLoadProvider) {
    ...
    $stateProvider
      ...
      .state('dashboard.memberAdd',{
          templateUrl:'views/member/member_add.html',
          url:'/memberadd'
      })
      .state('dashboard.memberView',{
          templateUrl:'views/member/member_view.html',
          url:'/memberview'
      })
      .state('dashboard.memberEdit',{
          templateUrl:'views/member/member_edit.html',
          url:'/memberedit'
      })
      ...
      .state('dashboard.userEdit',{
          templateUrl:'views/admin/user_edit.html',
          url:'/useredit'
      })
